...
questions = [
    {
        ...
        "options": ["2value", "value_2", "value-2", "class"],
        "answer": "value_2"
    },
    {
    ...
    {
        "question": "Which algorithum technique uses recursion and subproblems?",
        "options": ["Greedy","Brute Force", "Dynamic Programming", "Backtracking"],
        "answer": "Dynamic Programming"
    },
    {
        "question": "Which data structure folows the LIFO principle?",
